...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.create = function (resquest, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, firstName, lastName, password, createUserService, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = resquest.body, email = _a.email, firstName = _a.firstName, lastName = _a.lastName, password = _a.password;
