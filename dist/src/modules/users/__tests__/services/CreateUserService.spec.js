...
describe('CreateUser', function () {
    beforeEach(function () {
        ...
        createUserService = new CreateUserService_1.default(fakeUserRepository, fakeTokenProvider, fakeHashProvider);
    });
    ...
    it('should not be able to create a new user with email is already exist', function () { return __awaiter(void 0, void 0, void 0, function () {
