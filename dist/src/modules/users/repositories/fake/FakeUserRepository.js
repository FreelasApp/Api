...
var FakeUserRepository = /** @class */ (function () {
    ...
    FakeUserRepository.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                user = this.userRepository.find(function (userItem) { return userItem.id === id; });
    ...
    FakeUserRepository.prototype.findByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                user = this.userRepository.find(function (userItem) { return userItem.email === email; });
                return [2 /*return*/, user];
            });
        });
    };
    ...
    FakeUserRepository.prototype.save = function (userData) {
        return __awaiter(this, void 0, void 0, function () {
            var index;
            return __generator(this, function (_a) {
                index = this.userRepository.findIndex(function (user) { return user.id === userData.id; });
                if (index === -1) {
